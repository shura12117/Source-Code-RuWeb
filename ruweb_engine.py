...
class RuwebEngine:
    """Движок трансляции .ruweb в HTML5 + JavaScript (v3.0 — отступы)"""
    ...
    def __init__(self):
        ...
        self.russian_js = {
            ...
            'неопределено': 'undefined', 'и': '&&', 'или': '||', 'не': '!',
            'равно': '===', 'не_равно': '!==',
            ...
            'индекс': 'indexOf', 'длина': 'length', 'добавить': 'push',
            'срез': 'slice', 'соединить': 'join', 'сортировать': 'sort',
            'перевернуть': 'reverse', 'фильтр': 'filter', 'карта': 'map',
            'найти': 'find',
            ...
            'цель_события': 'event.target', 'сейчас': 'Date.now',
            'новая_дата': 'new Date', 'таймер': 'setTimeout',
            'интервал': 'setInterval', 'остановить_таймер': 'clearTimeout',
    ...
    def translate(self, ruweb_code):
        ...
        while i < n:
            ...
            # ===== блок СТИЛИ (заканчивается отступом ИЛИ /стили) =====
            ...
            # ===== блок СЦЕНАРИЙ (заканчивается отступом ИЛИ /сценарий) =====
